        ...
        // plays an already-extracted local file -- no re-download.
        {
            ...
            if (isZip) {
                ...
                try {
                    ...
                    // Log archive failures rather than swallowing them silently
                    // (a silent catch hid a Windows miniz symbol-collision bug
                    // that broke all ZIP extraction -- see archive.cpp).
