...
#define _FILEUTILS_H
#include <stdio.h>
// [chipmachine local patch] fileutils/abstract.cpp throws ENXIO but only pulled
// <errno.h> transitively on Furnace's own toolchain; include it explicitly.
// Re-apply on Furnace revendor.
#include <cerrno>
