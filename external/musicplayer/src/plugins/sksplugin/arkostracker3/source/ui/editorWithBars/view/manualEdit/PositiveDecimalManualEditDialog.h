...
/** A concrete edit dialog with a positive number, in decimal. */
class PositiveDecimalManualEditDialog final : public BaseManualEditDialog
{
public:
    /**
     * Constructor.
     ...
     */
    PositiveDecimalManualEditDialog(const juce::String& title, int minimumValue, int maximumValue, const std::function<juce::String(juce::String)>& validateCallback,
