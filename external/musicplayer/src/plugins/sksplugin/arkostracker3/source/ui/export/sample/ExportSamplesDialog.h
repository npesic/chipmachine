...
/** Dialog to export samples. */
class ExportSamplesDialog final : public ModalDialog,
...
public:
     ...
     */
    ExportSamplesDialog(const MainController& mainController, std::function<void()> listener) noexcept;
...
private:
    ...
    juce::TextEditor::LengthAndCharacterRestriction restrictionPitch;
