...
# include <libgen.h>	 /* no GNU version of basename() with mingw or apple */
#endif
 ...
 */
ZZ_EXTERN_C
zz_err_t zz_vfs_register(const vfs_dri_t * dri);
ZZ_EXTERN_C
zz_err_t zz_vfs_unregister(const vfs_dri_t * dri);
ZZ_EXTERN_C
const char * zz_vfs_uri(vfs_t vfs);
ZZ_EXTERN_C
void zz_vfs_instance_del(vfs_t * pvfs);
ZZ_EXTERN_C
vfs_t zz_vfs_new(const char * uri, ...);
ZZ_EXTERN_C
zz_err_t zz_vfs_open_uri(vfs_t * pvfs, const char * uri);
ZZ_EXTERN_C
zz_err_t zz_vfs_open(vfs_t vfs);
ZZ_EXTERN_C
zz_u32_t zz_vfs_read(vfs_t vfs, void *b, zz_u32_t n);
ZZ_EXTERN_C
zz_err_t zz_vfs_read_exact(vfs_t vfs, void *b, zz_u32_t n);
ZZ_EXTERN_C
zz_u32_t zz_vfs_tell(vfs_t vfs);
ZZ_EXTERN_C
zz_u32_t zz_vfs_size(vfs_t vfs);
ZZ_EXTERN_C
zz_err_t zz_vfs_seek(vfs_t vfs, zz_u32_t pos, zz_u8_t set);
ZZ_EXTERN_C
zz_err_t zz_vfs_push(vfs_t vfs, const void * b, zz_u8_t n);
